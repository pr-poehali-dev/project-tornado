export function Footer() {
  const footerLinks = {
    "Каталог": ["Игровые мыши", "Офисные", "Эргономичные", "Беспроводные", "С подсветкой", "Новинки", "Акции"],
    "Помощь": ["Помощник выбора", "Сравнение моделей", "Обзоры", "3D-просмотр", "Гарантия", "Доставка", "Возврат"],
    "Компания": ["О нас", "Наши бренды", "Партнёры", "Новости", "Блог", "Карьера", "Контакты"],
    "Поддержка": ["Часто задаваемые вопросы", "Онлайн-чат", "Личный кабинет", "Отслеживание заказа", "Политика", "Оферта"],
    "Соцсети": ["ВКонтакте", "Telegram", "YouTube", "Instagram", "TikTok"],
  }
